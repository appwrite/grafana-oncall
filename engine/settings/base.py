...
# Discord
FEATURE_DISCORD_INTEGRATION_ENABLED = getenv_boolean("FEATURE_DISCORD_INTEGRATION_ENABLED", default=False)
DISCORD_BOT_TOKEN = os.environ.get("DISCORD_BOT_TOKEN")
# The application's Ed25519 public key, used to verify interactions Discord posts to the interactions endpoint.
DISCORD_PUBLIC_KEY = os.environ.get("DISCORD_PUBLIC_KEY")

if FEATURE_DISCORD_INTEGRATION_ENABLED:
    INSTALLED_APPS += ["apps.discord"]
...
if IS_OPEN_SOURCE:
    ...
    PHONE_PROVIDERS["msg91"] = "apps.msg91.phone_provider.MSG91PhoneProvider"
...
MSG91_AUTH_KEY = os.getenv("MSG91_AUTH_KEY", None)
MSG91_SENDER_ID = os.getenv("MSG91_SENDER_ID", None)
